...
public class OAuth2Config extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        .withClient("tonr")
                ...
                .autoApprove(true)
                .and()
                .withClient("rsmShark").scopes("read", "write")
				.authorities(AuthoritiesConstants.ADMIN, AuthoritiesConstants.USER)
				.authorizedGrantTypes("password", "refresh_token", "authorization_code", "implicit").secret("krahsMsr")
				.accessTokenValiditySeconds(50000).redirectUris(defaultRedirectUri);
